...
estimators = [
	('bagging',BaggingClassifier(base_estimator=pipeline,n_estimators=100,max_features=4,max_samples=10,random_state=1, n_jobs=5)),
	('addaBoost', AdaBoostClassifier(DecisionTreeClassifier(max_depth=1),n_estimators=200))
]
...
estimators = [
	('bagging',BaggingClassifier(base_estimator=pipeline, n_estimators=100,max_features=4,max_samples=100,random_state=1, n_jobs=5)),
	('addaBoost', AdaBoostClassifier(DecisionTreeClassifier(max_depth=1),n_estimators=200))
]
